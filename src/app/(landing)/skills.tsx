...
const Skills: React.FC = () => {
  return (
    <div className="">
      <h2 className="relative after:absolute after:-bottom-1 after:left-0 after:h-1 after:w-2/3 after:py-0.5 after:bg-[#8AC776] max-w-xs text-3xl font-semibold leading-10 tracking-tight text-black dark:text-red-50">
        Skills
      </h2>
